...
?>
 <form action="<?php echo $edit?'edit_category.php':'insert_category.php'; ?>" method="post" style="margin: 5px;">
 	<table border="0">
 		<tr>
 			<td>Category Name:</td>
 		...
 		<tr>
 			...
 			<?php 
 				if($edit){
 					//allow deletion of existing categorieds
 					echo "<td>
                		<form method=\"post\" action=\"delete_category.php\" style=\"margin:5px;\">
...
<?php
 ...
 function display_book_form($book=''){
	...
	//most of the form is in plain HTML with some optional PHP bits throughout
?>
	<form action="<?php echo $edit ? 'edit_book.php' : 'insert_book.php'; ?>" method="post" style="margin: 5px;">
		<table border="0">
			<tr>
				<td>ISBN:</td>
				<td>
  			...
  			<tr>
   			...
   			<tr>
   				...
   				<?php 
   					if ($edit) {
		             echo "<td>
		                   <form method=\"post\" action=\"delete_book.php\" style=\"margin:5px;\">
...
<?php
 ...
 function delete_category($catid){
 	...
 	//bo removed and the function will return false.
